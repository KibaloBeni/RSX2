 ...
 * Changement des resolvers dns                                                        - Laurent NOE - Octobre 2023
 */
 ...
 * utiliser "ns1.univ-lille.fr" (sinon "ns2.univ-lille.fr") sur l'universite ou a l'exterieur de l'universite (sniff : sans autorite/additionel ...)
 * utiliser "dns1.unv-lille.fr" (sinon "dns2.univ-lille.fr") sur l'universite (sans autorite/additionel)
 */

/* Commande a comparer avec :
 * dig +noedns @ns1.univ-lille.fr ns1.univ-lille.fr
 * dig +noedns @ns1.univ-lille.fr www.cristal.univ-lille.fr
 * 
 * dig +noedns @dns1.univ-lille.fr www.univ-lille.fr
 * dig +noedns @dns1.univ-lille.fr smtp.univ-lille.fr
 * dig +noedns @dns1.univ-lille.fr mx1.univ-lille.fr
 *   ...
 * dig         @dns1.univ-lille.fr www.chronos.com
 * dig         @dns1.univ-lille.fr www.azure.com
 * dig +noedns @dns1.univ-lille.fr www.azure.com
 *
 */
...
#define DESTNAME "resolv1.univ-lille.fr"
#define DESTPORT "53"

#else

#define DESTIPV4 "194.254.129.83"
#define DESTPORT 53
...
unsigned char query[NS_QUERY_LEN] = {
  ...
  0x76,  0x2d,  0x6c,  0x69,
  0x6c,  0x6c,  0x65,  0x02,
  0x66,  0x72,  0x00,        // b.1) QNAME:  3"www"a"univ-lille"2"fr"0  [RFC1035, partie 3.1]
  0x00,  0x01,               // b.2) QTYPE: A (a host address)          [RFC1035, partie 3.2.3]
  0x00,  0x01                // b.3) QCLASS : IN (the Internet)         [RFC1035, partie 3.2.4]
};
*/
